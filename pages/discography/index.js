    ...
    return (
        <>
            ...
            <Layout>
                ...
                <AlbumItem title='FULL ALBUM (2023/2024)' subtitle='Composing for the album is finished and we are on a pre-production phase. You can support us for our future release, by making a donation.' img={newAlbumImg} link='/donate/' btnText='DONATE' release='LP ALBUM' />
            </Layout>
        </>
    );
}
