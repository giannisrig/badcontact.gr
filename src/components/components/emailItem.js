...
export default function EmailItem({title, text, email}) {
    ...
    return (
       <div className={styles.item}>
           <div className={styles.textContainer}>
               ...
               <h4 className={`${styles.text} ${fonts.grava400.className}`}>
                   {text}
               </h4>
           </div>
           <div className={styles.emailContainer}>

               <textarea className={`${styles.textarea} ${fonts.grava700.className}`} ref={textAreaRef} value={email} onFocus={copyClipboard} readOnly={true} />
